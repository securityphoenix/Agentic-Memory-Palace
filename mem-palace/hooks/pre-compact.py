...
from scan_sensitive_data import SensitiveDataError, assert_text_safe  # noqa: E402
...
def main() -> None:
    ...
    try:
        assert_text_safe(context, source=f"pre-compact:{session_id}")
    except SensitiveDataError as e:
        logging.error("SKIP: sensitive data detected in pre-compact context:\n%s", e)
        return
